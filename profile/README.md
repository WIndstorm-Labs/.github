...
## Track 2 — Entropic Bounds in Analog Systems · 7 papers (Papers 10–16 globally)
...
| 14 | [escrow-spacetime](https://github.com/Windstorm-Labs/escrow-spacetime) | ✅ Published | [10.5281/zenodo.20126091](https://doi.org/10.5281/zenodo.20126091) | numpy + scipy.linalg — CPU; cross-references the lattice runs from Paper 13 (translation paper has no new compute beyond Paper 11's framework) |
| 15 | [nesc-recipe](https://github.com/Windstorm-Labs/nesc-recipe) | ✅ Published | [10.5281/zenodo.20145106](https://doi.org/10.5281/zenodo.20145106) | numpy + scipy.linalg — CPU; 1+1D scalar field lattice at N ∈ [200, 1200]; BW-identification + Casini–BW saturation tests |
| 16 | [compton-corollary](https://github.com/Windstorm-Labs/compton-corollary) | ✅ Published | [10.5281/zenodo.20163451](https://doi.org/10.5281/zenodo.20163451) | python stdlib (math.exp, math.log2) — CPU (<1s); reproduces §3 ratios table |
---
